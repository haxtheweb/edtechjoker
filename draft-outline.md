...
## Week 12
Sunday check in is all code based. I should be seeing code that I can throw up for review in class. Any problems, document them in your check in for week 3. If you have questions, ask them in your check in. So there is a small written check in but its mostly reviewing code.
