...
## NPM
Node Package Manager or NPM for short is where developers can find, create or build code packages. This can be especially useful for web develoopment where developers have large amount of code and they can use the package manager to handle dependencies. npm is the world largest software registry and currently contains over 800,000 code packages. These packages are open source. [for more info check out](https://www.npmjs.com/)
